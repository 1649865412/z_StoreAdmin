...
<cartmatic:swf_upload btnPlaceHolderId="url_btnPlaceHolderId" fileInputId="url" uploadFileTypes="*.jpg;*.gif;*.swf;*.mp4;*.webm;*.ogv" uploadCategory="a_and_d" button_text="上传图片" fileSizeLimit="50MB"></cartmatic:swf_upload>
