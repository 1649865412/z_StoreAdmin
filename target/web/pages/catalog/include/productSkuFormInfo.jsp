		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-content">
			...
			<tr>
             ...
             <tr>
				...
				<td>
					<div style="float: left;">
						<cartmatic:img url="${productSku.image2}" id="productImage2" mediaType="product" size="b" width="72" height="72"></cartmatic:img>
					</div>
					<div style="float: left; margin: 20px;">
						<input type="hidden" name="image2" id="image2" value="${productSku.image2}" />
						<span id="skuImgBtnPlaceHolderId2"></span>
						<br/>
						(<fmt:message key="productSku.image.desc" />)
					</div>
				</td>
...
<cartmatic:swf_upload btnPlaceHolderId="skuImgBtnPlaceHolderId2" uploadCategory="product" uploadFileTypes="*.jpg" previewImg="productImage2" objId="${product.productId}" previewSize="b" fileInputId="image2" button_text="上传图片"></cartmatic:swf_upload>
