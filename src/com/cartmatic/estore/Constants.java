...
public class Constants {
	...
	public final static Integer INFORMATION_TYPE_BRAND = new Integer(1);		//入驻品牌新闻类型
	public final static Integer INFORMATION_TYPE_FASHION = new Integer(2);	//时尚展览信息类型
	public final static Integer INFORMATION_TYPE_ACTIVITY = new Integer(3);	//线下活动信息类型
}